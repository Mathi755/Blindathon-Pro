...
const CodeForm: React.FC<CodeFormProps> = ({ questions, onSubmitForm }) => {
  ...
  useEffect(() => {
    ...
    const newLineNumbers = Array.from({ length: lines.length }, (_, i) =>
      String(i + 1)
    );
  ...
  return (
    <div className="form-container relative">
      ...
      <Dialog
        open={showCompletionMessage}
        onOpenChange={setShowCompletionMessage}
      >
          ...
          <div className="mt-4 space-y-4">
            <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
              ...
              <p className="text-slate-300 mb-2">
                Your solutions have been received and recorded.
              </p>
              <p className="text-slate-300 mb-4">
                Results will be announced soon by the organizing team.
              </p>
            ...
            <div className="bg-slate-900 p-4 border border-slate-700 rounded-b-lg">
              <div className="mb-4">
                {terminalActivity.map((line, index) => (
                  <div
                    key={index}
                    className="text-xs font-mono text-green-500 mb-1 flex"
                  >
            ...
            <textarea
              ...
              onCopy={(e) => {
                ...
                toast("Copying is disabled for this challenge", {
                  description:
                    "Show your true coding skills without copying solutions!",
                });
              }}
              onPaste={(e) => {
                e.preventDefault();
